...
vis_max_slider_label = uicontrol(visTab,...
                                   'Style','text',...
                                   'Units','normalized',...
                                   'Position',[.675 .72 .31 COMPONENT_HEIGHT],...
                                   'String','Max Display:',...
                                   'BackgroundColor',lt_gray,...
                                   'ForegroundColor',charcoal_gray,...
                                   'FontUnits',FONT_UNITS,...
                                   ...
                                   'HorizontalAlignment','left',...
                                   'FontWeight','bold');
vis_max_slider_label.FontSize = FONT_SIZE/vis_max_slider_label.Position(4);

vis_max_slider = uicontrol(visTab,...
                                   'Style','slider',...
                                   'Units','normalized',...
                                   'Position',[.675 .67 .31 COMPONENT_HEIGHT],...
                                   'String','Colormap:',...
                                   'BackgroundColor',lt_gray,...
                                   'ForegroundColor',charcoal_gray,...
                                   'FontUnits',FONT_UNITS,...
...
vis_max_slider.FontSize = FONT_SIZE/vis_max_slider.Position(4);

vis_min_slider_label = uicontrol(visTab,...
                                   'Style','text',...
                                   'Units','normalized',...
                                   'Position',[.675 .62 .31 COMPONENT_HEIGHT],...
                                   'String','Min Display:',...
                                   'BackgroundColor',lt_gray,...
                                   'ForegroundColor',charcoal_gray,...
                                   'FontUnits',FONT_UNITS,...
                                   ...
                                   'HorizontalAlignment','left',...
                                   'FontWeight','bold');
vis_min_slider_label.FontSize = FONT_SIZE/vis_min_slider_label.Position(4);

vis_min_slider = uicontrol(visTab,...
                                   'Style','slider',...
                                   'Units','normalized',...
                                   'Position',[.675 .57 .31 COMPONENT_HEIGHT],...
                                   'Value',1,...
                                   'String',COLORMAPS,...
                                   'BackgroundColor','white',...
                                   'ForegroundColor',charcoal_gray,...
                                   ...
                                   'FontName',FONT_NAME,...
                                   'Callback', @changeLimit);
vis_min_slider.FontSize = FONT_SIZE/vis_min_slider.Position(4);
...
file_img_panel.ResizeFcn = @resizeFilePanel;
    function changeLimit(varargin)
        minVal = vis_min_slider.Value;
        maxVal = vis_max_slider.Value;
        vis_img_axis.CLim = [minVal maxVal];
    end
    ...
    function updateFeaturesPopup(varargin)
        if isempty(labeled_images)
            ...
            features = {'LabeledImage'};
            
            if ~isempty(intensity_images)
                features = [features {'IntensityImage'}];
            end
    ...
    function [featureImage] = generateVisFigure(lblImage)
        ...
        if strcmp(feature,'LabeledImage') || strcmp(feature,'IntensityImage')
            featureImage = (edges==0).*double(lblImage);
            return
        ...
        featureTable = allStats(strcmp(allStats.LabeledImage,labeled_images{current_frame}),:);

        objVal = featureTable.(feature);
        ...
        vis_min_slider.Min = min(featureTable.(feature));
        vis_max_slider.Min = min(featureTable.(feature));
        vis_min_slider.Max = max(featureTable.(feature));
        vis_max_slider.Max = max(featureTable.(feature));
        vis_min_slider.Value = vis_min_slider.Min;
        vis_max_slider.Value = vis_max_slider.Max;
    end
